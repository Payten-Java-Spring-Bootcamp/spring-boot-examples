...
//swagger ile alakali tum konfigruasyonu burada yapacagiz ki yonetmesi zor olmasin

@Configuration
@EnableSwagger2 //swagger i aktif et
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                ...
                .build().apiInfo(apiEndPointsInfo()); //api genel bilgisi
